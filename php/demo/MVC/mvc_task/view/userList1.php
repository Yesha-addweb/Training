...
<table cellpadding="10" cellspacing="5">
    <tr>
        <td colspan="10" align="center"><a href="index1.php?op=add">Add User</a></td>
    </tr>
    ...
    if ($noofrow > 0) {
        while ($resultArray = mysqli_fetch_array($result)) { ?>
            ...
            <td><a onClick="javascript: return confirm('Please confirm deletion');"
                   href="index1.php?op=delete&id=<?php echo $resultArray['id']; ?>">Delete</a></td>
            </tr><?php
        }
    } else { ?>
...
<div>
    <label>
        <a href="index1.php">All</a>
    </label>
    <label>
        <a href="index1.php?op=filter&id=1">Active</a>
    </label>
    <label>
        <a href="index1.php?op=filter&id=0">Inactive</a>
    </label>
</div>